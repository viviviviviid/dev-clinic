...
import { desktopWorkspace } from '../../lib/runtimeConfig'
import './Settings.css'
        ...
        <div className="settings-main">
          <div className="settings-content">
            ...
            <section className="settings-section" aria-labelledby="storage-directory-title">
              ...
              <p className="settings-hint">{isDesktop() ? <>학습 파일은 <code>{desktopWorkspace()}</code>에 저장됩니다.</> : <>clinic 실행 시 CLI 인자로 지정합니다. 예: <code>./run.sh ~/learning</code></>}</p>
              {initial?.base_dir ? (
